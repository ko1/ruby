# 1 readers accumulate copied batches; main forces GC.start between sends (mid-send adversarial window)
# axes: 1 ractors, copy send, GC.start, gc at bounded send boundaries
...
puts "OK g01_gcstart_between_copysends_r1"
