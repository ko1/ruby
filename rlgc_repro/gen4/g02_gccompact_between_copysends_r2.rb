# 2 readers accumulate copied batches; main forces GC.compact between sends (mid-send adversarial window)
# axes: 2 ractors, copy send, GC.compact, gc at bounded send boundaries
...
puts "OK g02_gccompact_between_copysends_r2"
