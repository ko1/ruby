# 8 readers accumulate copied batches; main forces GC.compact between sends (mid-send adversarial window)
# axes: 8 ractors, copy send, GC.compact, gc at bounded send boundaries
...
puts "OK g08_gccompact_between_copysends_r8"
