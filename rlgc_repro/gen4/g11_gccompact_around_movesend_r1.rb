# main moves batches to 1 sinks, driving GC.compact before and after a move (materialization window)
# axes: 1 ractors, move send, GC.compact, gc around bounded set of moves
...
puts "OK g11_gccompact_around_movesend_r1"
