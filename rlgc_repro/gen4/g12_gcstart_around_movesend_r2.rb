# main moves batches to 2 sinks, driving GC.start before and after a move (materialization window)
# axes: 2 ractors, move send, GC.start, gc around bounded set of moves
...
puts "OK g12_gcstart_around_movesend_r2"
