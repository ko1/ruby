# main moves batches to 3 sinks, driving GC.compact before and after a move (materialization window)
# axes: 3 ractors, move send, GC.compact, gc around bounded set of moves
...
puts "OK g13_gccompact_around_movesend_r3"
