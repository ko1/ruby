# main moves batches to 7 sinks, driving GC.compact before and after a move (materialization window)
# axes: 7 ractors, move send, GC.compact, gc around bounded set of moves
...
puts "OK g17_gccompact_around_movesend_r7"
