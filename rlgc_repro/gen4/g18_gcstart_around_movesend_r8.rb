# main moves batches to 8 sinks, driving GC.start before and after a move (materialization window)
# axes: 8 ractors, move send, GC.start, gc around bounded set of moves
...
puts "OK g18_gcstart_around_movesend_r8"
