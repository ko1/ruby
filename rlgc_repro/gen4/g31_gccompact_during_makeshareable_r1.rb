# build nested structures, Ractor.make_shareable under GC.compact pressure, then 1 readers sum shared bytes
# axes: 1 readers, shareable share, GC.compact, gc during make_shareable
...
puts "OK g31_gccompact_during_makeshareable_r1"
