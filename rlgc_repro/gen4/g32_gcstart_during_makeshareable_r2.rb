# build nested structures, Ractor.make_shareable under GC.start pressure, then 2 readers sum shared bytes
# axes: 2 readers, shareable share, GC.start, gc during make_shareable
...
puts "OK g32_gcstart_during_makeshareable_r2"
