# build nested structures, Ractor.make_shareable under GC.compact pressure, then 3 readers sum shared bytes
# axes: 3 readers, shareable share, GC.compact, gc during make_shareable
...
puts "OK g33_gccompact_during_makeshareable_r3"
