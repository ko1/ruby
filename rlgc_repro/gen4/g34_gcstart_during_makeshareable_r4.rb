# build nested structures, Ractor.make_shareable under GC.start pressure, then 4 readers sum shared bytes
# axes: 4 readers, shareable share, GC.start, gc during make_shareable
...
puts "OK g34_gcstart_during_makeshareable_r4"
