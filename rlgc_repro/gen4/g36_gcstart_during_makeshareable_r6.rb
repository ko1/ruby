# build nested structures, Ractor.make_shareable under GC.start pressure, then 6 readers sum shared bytes
# axes: 6 readers, shareable share, GC.start, gc during make_shareable
...
puts "OK g36_gcstart_during_makeshareable_r6"
