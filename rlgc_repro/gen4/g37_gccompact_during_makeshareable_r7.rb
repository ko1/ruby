# build nested structures, Ractor.make_shareable under GC.compact pressure, then 7 readers sum shared bytes
# axes: 7 readers, shareable share, GC.compact, gc during make_shareable
...
puts "OK g37_gccompact_during_makeshareable_r7"
