# build nested structures, Ractor.make_shareable under GC.compact pressure, then 2 readers sum shared bytes
# axes: 2 readers, shareable share, GC.compact, gc during make_shareable
...
puts "OK g39_gccompact_during_makeshareable_r2"
