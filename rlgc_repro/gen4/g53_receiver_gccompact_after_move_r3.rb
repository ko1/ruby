# 3 sinks GC.compact right after receiving a moved batch, then read it (post-materialization read)
# axes: 3 ractors, move send, GC.compact inside receiver, gc right after receive
...
puts "OK g53_receiver_gccompact_after_move_r3"
