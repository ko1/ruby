# 6 sinks GC.start right after receiving a moved batch, then read it (post-materialization read)
# axes: 6 ractors, move send, GC.start inside receiver, gc right after receive
...
puts "OK g56_receiver_gcstart_after_move_r6"
