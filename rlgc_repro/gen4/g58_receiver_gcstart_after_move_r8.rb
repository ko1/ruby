# 8 sinks GC.start right after receiving a moved batch, then read it (post-materialization read)
# axes: 8 ractors, move send, GC.start inside receiver, gc right after receive
...
puts "OK g58_receiver_gcstart_after_move_r8"
