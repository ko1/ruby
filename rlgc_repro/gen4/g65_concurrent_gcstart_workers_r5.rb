# 5 workers concurrently GC.start while main streams copied batches (concurrent GC during receive)
# axes: 5 ractors, copy send, GC.start concurrent in workers, gc during receive stream
...
puts "OK g65_concurrent_gcstart_workers_r5"
