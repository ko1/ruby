# 7 workers concurrently GC.start while main streams copied batches (concurrent GC during receive)
# axes: 7 ractors, copy send, GC.start concurrent in workers, gc during receive stream
...
puts "OK g67_concurrent_gcstart_workers_r7"
