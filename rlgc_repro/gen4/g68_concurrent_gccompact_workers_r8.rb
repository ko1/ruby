# 8 workers concurrently GC.compact while main streams copied batches (concurrent GC during receive)
# axes: 8 ractors, copy send, GC.compact concurrent in workers, gc during receive stream
...
puts "OK g68_concurrent_gccompact_workers_r8"
