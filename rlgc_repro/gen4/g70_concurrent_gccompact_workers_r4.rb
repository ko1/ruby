# 4 workers concurrently GC.compact while main streams copied batches (concurrent GC during receive)
# axes: 4 ractors, copy send, GC.compact concurrent in workers, gc during receive stream
...
puts "OK g70_concurrent_gccompact_workers_r4"
