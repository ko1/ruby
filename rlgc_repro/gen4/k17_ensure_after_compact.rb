# ensure ブロックが die/finish 前に port へマーカー送出(compact)
# axes: ensure,side,compact
...
raise 'fails' unless fails == 0
puts "OK k17_ensure_after_compact"
