# 例外オブジェクトを 2 段の Ractor で中継(各段で copy)、ivar 保持を検証
# axes: relay,copy,hop2
Warning[:experimental] = false
GC.stress = true if ENV['S_STRESS']
class Relay2 < StandardError
  attr_reader :seq, :tag
