# 例外オブジェクトを 4 段の Ractor で中継(各段で copy)、ivar 保持を検証
# axes: relay,copy,compact
Warning[:experimental] = false
GC.stress = true if ENV['S_STRESS']
class Relay4 < StandardError
  attr_reader :seq, :tag
